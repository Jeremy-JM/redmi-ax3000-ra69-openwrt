...
CONFIG_CCACHE=y
CONFIG_CCACHE_DIR="/home/hezeyao/.ccache"
...
CONFIG_FEED_dockerman=y
CONFIG_FEED_opentopd=y
...
CONFIG_PACKAGE_luci-app-dnsto=m
...
CONFIG_PACKAGE_luci-app-switch-lan-play=y
...
CONFIG_PACKAGE_luci-i18n-ahcp-en=y
...
CONFIG_PACKAGE_luci-i18n-dnspod-zh-cn=y
...
CONFIG_PACKAGE_luci-i18n-koolddns-zh-cn=y
...
CONFIG_PACKAGE_luci-i18n-p910nd-en=y
CONFIG_PACKAGE_luci-i18n-p910nd-zh-cn=y
CONFIG_PACKAGE_luci-i18n-passwall-zh-cn=y
CONFIG_PACKAGE_luci-i18n-passwall2-zh-cn=y
CONFIG_PACKAGE_luci-i18n-polipo-en=y
...
CONFIG_PACKAGE_luci-i18n-tencentddns-zh-cn=y
...
CONFIG_PACKAGE_luci-i18n-wifidog-zh-cn=y
...
# Lan-play
#
CONFIG_PACKAGE_switch-lan-play=y
# end of Lan-play
